defmodule Pythelix.Game.Modes.HandlerTest do
  ...
  setup do
    ...
    {:ok, character} =
      Record.create_entity(
        key: "test_character",
        virtual: true,
        parent: Record.get_entity("generic/character")
      )
    ...
    Record.create_entity(
      key: "menu/game",
      virtual: true,
      parent: Record.get_entity("generic/menu")
    )
  ...
  describe "game mode input handling" do
    ...
    test "handles pipe operators for mode switching", %{client: client, menu: menu} do
      ...
      game_modes = Record.get_attribute(character, "game_modes")
      # Should wrap to 0 (3 total modes: 0, 1, 2)
      assert game_modes.active == 0
    end
